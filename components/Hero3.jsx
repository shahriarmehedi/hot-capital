...
function Hero3() {
    return (
        <div className='max-w-7xl mx-auto mt-14 px-5 2xl:px-0'>
            <div className="flex flex-col lg:flex-row gap-7">
                <div className='bg-[#076241] text-white font-bold text-4xl p-10 rounded-3xl text-center flex justify-center items-center'>
                    contacto directo con inversionistas
                </div>
                <div className='w-full'>
                    <img src="image 49.png" alt="Hero" className='w-full' />
                </div>
                <div className='bg-[#F8F4E8] font-bold text-4xl p-10 rounded-3xl text-center flex justify-center items-center text-[#F8A703]'>
                    ganancia gratis los primeros 6%
                </div>
            </div>
